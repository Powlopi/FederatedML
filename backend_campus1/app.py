...
def retrieve_global_model():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return jsonify({"status": "success", "message": "Global model downloaded to Campus 1."}), 200
        else:
...
def train_model():
    ...
    if result["status"] == "success":
        ...
        versioned_path = os.path.join(MODELS_DIR, f'local_model_campus1_v{next_v}.pkl')
